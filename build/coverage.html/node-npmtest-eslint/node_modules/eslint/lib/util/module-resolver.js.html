...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint/node_modules/eslint/lib/util/module-resolver.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint/node_modules/eslint/lib/util/module-resolver.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint/node_modules/eslint/lib/util/</a> &#187; module-resolver.js</div>
</div>
<div class="body">
...
&nbsp;
     ...
     */
    lookupPaths: module.paths ? module.paths.concat(Module.globalPaths) : <span class="branch-1 cbranch-no" title="branch not covered" >Module.globalPaths.concat()</span>
};
&nbsp;
/**
...
&nbsp;
     ...
     */
    resolve<span class="fstat-no" title="function not covered" >(name, extraLookupPath) {</span>
&nbsp;
        /*
         ...
         */
<span class="cstat-no" title="statement not covered" >        const lookupPaths = this.options.lookupPaths.concat();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        lookupPaths.unshift(extraLookupPath);</span>
&nbsp;
        /**
         ...
         */
<span class="cstat-no" title="statement not covered" >        const result = Module._findPath(name, lookupPaths); </span>  // eslint-disable-line no-underscore-dangle
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!result) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error(`Cannot find module '${name}'`);</span>
        }
&nbsp;
